...
\begin{table}[htb]
	\centering
	\begin{tabular}{| l | >{\centering\arraybackslash}l{1in} | >{\centering\arraybackslash}l{1in} | >{\centering\arraybackslash}l{1in} | >{\centering\arraybackslash}l{1in} | >{\centering\arraybackslash}l{1in} | >{\centering\arraybackslash}l{1in} | >{\centering\arraybackslash}l{1in} | >{\centering\arraybackslash}l{1in} |}
	\hline
