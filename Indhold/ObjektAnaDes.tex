...
\begin{table}[htb] % God Fucking Dammit Sådan Noget Lorte Tabel Shit!
	\small %Mindre tekst - snyd for at få tabellen til at være der...
	\newcolumntype{C}{>{\centering}X}%Store C "breder sig" så meget som muligt..
	\setlength{\tabcolsep}{5pt} %Lidt snyd for at få tabellen til at være der...
