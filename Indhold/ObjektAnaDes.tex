...
\begin{table}[htb]
	\centering
	\begin{tabular}{| p{1.5cm} | >{\centering\arraybackslash}m{1.6cm}{1in} | >{\centering\arraybackslash}m{1.5cm}{1in} | >{\centering\arraybackslash}m{1.6cm}{1in} | >{\centering\arraybackslash}m{1.5cm}{1in} | >{\centering\arraybackslash}m{1.6cm}{1in} | >{\centering\arraybackslash}m{1.5cm}{1in} | >{\centering\arraybackslash}m{1.6cm}{1in} | >{\centering\arraybackslash}m{1.5cm}{1in} |}
	\hline
