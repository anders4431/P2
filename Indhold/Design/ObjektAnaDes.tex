...
\begin{table}[htb]
	...
	\begin{tabularx}{\textwidth}{|>{\bfseries}l|c|c|c|C|C|c|c|c|}
		...
		\textbf{Anmodning} &   &   & + & + &   &   &   &  						\tabularnewline \hline
	\end{tabularx}
